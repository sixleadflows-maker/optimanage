...
export type SnapshotTrashKind = "invoice" | "return" | "expense" | "prescription" | "labOrder" | "purchaseOrder" | "stockAdjustment" | "payment";
export type TrashKind = SoftTrashKind | SnapshotTrashKind;
export const SNAPSHOT_TRASH_KINDS: readonly SnapshotTrashKind[] = [
  "invoice", "return", "expense", "prescription", "labOrder", "purchaseOrder", "stockAdjustment", "payment",
];
