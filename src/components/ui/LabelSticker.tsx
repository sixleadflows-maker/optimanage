...
export function LabelSticker({
  ...
  return (
    ...
    >
      <p className="text-[10px] font-semibold text-center leading-tight px-1 w-full truncate">{title}</p>
      <p className="text-[10px] font-bold leading-tight">{formatCurrency(price)}</p>
      {barcode ? (
