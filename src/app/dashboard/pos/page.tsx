...
export default function POSPage() {
  ...
  const completeSale = () => {
    setShowReceipt(true);
    showToast("Sale completed successfully! (demo)", "success");
  };
    ...
    return (
      <div className="animate-fade-in">
        <div className="flex items-center justify-between mb-6">
          ...
          <button onClick={() => { setShowReceipt(false); setCart([]); setInvoiceDiscount(0); setSelectedCustomer(""); }}
            className="px-4 py-2 glass-card text-sm font-medium cursor-pointer">
            ← Back to POS
          </button>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="glass-card p-6">
            ...
            <div className="receipt-paper mx-auto rounded-lg shadow-lg">
              ...
              <p className="text-[10px]">INV: INV-2026-{String(31).padStart(3, "0")}</p>
              <p className="text-[10px]">Date: 18 Jun 2026, 11:30 AM</p>
            ...
            <div className="bg-white text-black rounded-lg p-6 shadow-lg text-sm">
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-gray-500">INV-2026-031</p>
                  <p className="text-xs text-gray-500">18 Jun 2026</p>
                </div>
              </div>
              {customer && (
            ...
            <>
              ...
              <div className="mt-4 space-y-3">
                ...
                <button
                  ...
                  className="w-full py-3 bg-primary text-white rounded-2xl text-sm font-semibold hover:bg-primary-hover transition-colors"
                >
